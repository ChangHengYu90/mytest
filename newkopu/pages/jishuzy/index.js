...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: that.data.href + 'api/Account/UserTypeList',
      method: 'get',
      data: {
    ...
    that.setData({
      ...
      lxr: wx.getStorageSync('userxq').account,
  ...
  submit: function () {
    ...
    let leixingid = that.data.yuanarray[that.data.index].Id
    ...
    console.log(data)
    wx.request({
      url: that.data.href + 'api/User/TechnologyTransferAdd',
      method: 'post',
      data: data,    //参数为键值对字符串
      header: {
        //设置参数内容类型为x-www-form-urlencoded
